...
SumSpecF = SumSpecF[-c(1:9),-c(4,8,9,12,15)] # remove uninteresting variables
# order the summary statistic output by (1) company and (2) variable
SumSpecF = SumSpecF[order(SumSpecF$group1, SumSpecF$vars),]
SumSpecF = SumSpecF[,-(1:3)] # cosmetic adjustment
