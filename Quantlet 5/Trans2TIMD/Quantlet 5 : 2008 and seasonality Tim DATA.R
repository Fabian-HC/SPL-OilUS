...
#load variable
load("./Quantlet 5/Trans2TIMD/DebtReturn.RData")
...
stargazer(repre2008, rePost2008, type="text", 
          ...
          out="./Quantlet 5/trans2TIMD/Regression-2008.txt")
...
#Random Effect with Dummy => DumP*BVE.MCAP


DumyReg = plm(Stock ~ A.MCAP+ NI + BVE.MCAP
              + D.MCAP + Oil + Gas + Market + EURUSD 
              + DumP*(A.MCAP) + DumP*NI + + DumP*D.MCAP# #DumP*(BVE.MCAP)#  
...
out="./Quantlet 5/trans2TIMD/Regression-Dummy2008.txt")
...
stargazer(Quarter,type="text",
          ...
          covariate.labels=c("Assets/market cap.","Net income","BVE/market cap.",
                             "Debt/equity","Oil price","Gas price", "DJI premium","EUR/Dollar"), 
          out="./Quantlet 5/trans2TIMD/QuarterDummy.txt")
...
stargazer(reOilC, reOtherC, type="text", 
          ...
          covariate.labels=c("Assets/market cap.","Net income","BVE/market cap.",
                             "Debt/equity","Oil price","Gas price", "DJI premium","EUR/Dollar"), 
          out="./Quantlet 5/trans2TIMD/Regression.Oil-Other.txt")
...
stargazer(TypeFirm,type="text",
          ...
          out="./Quantlet 5/trans2TIMD/Regression.DummyOil-Other.txt")
